# modded by @enicaaa & blyat kak suda popal @Yahikoro & @kawasaji.
...
class NumMod(loader.Module):
    "Обновленная версия Biomod, которая убирает в себе возможность показывать жертв/лабу/болезни\n Moded by @enicaaa & @kawasaji.\n По любым вопросам или желаниям @enicaaa"
    strings = {'name': 'Biomod security'}
